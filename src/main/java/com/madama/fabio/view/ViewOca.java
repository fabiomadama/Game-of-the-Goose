...
public class ViewOca extends JFrame
{
	...
	public void initGameGui()
	{
		...
		JPanel panel = configureLayout(componentGenerator);
		mainFrame.add(panel);
	 ...
	 */
	private JPanel configureLayout(ComponentGenerator componentGenerator)
	{
		...
		this.dice = componentGenerator.retrieveDices(this.billboard, this.messageBoard);
